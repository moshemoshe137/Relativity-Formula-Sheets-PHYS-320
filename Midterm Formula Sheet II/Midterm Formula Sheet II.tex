...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[scale = .98] %1/2 invariant 
		\begin{axis}[
		axis lines = left,
		...
		\end{axis}
		\end{tikzpicture}
		\begin{tikzpicture}[scale = .98] %1/2 world lines
		\begin{axis}[
		axis lines = left,
		axis line style = thick,
		title = {$\frac{\mathcal{V}}{c} = \frac{1}{2}$},
		...
		\end{axis}
		\end{tikzpicture}\\ 
		\begin{tikzpicture}[scale = .98] %1/2 length contraction
		\begin{axis}[
		axis lines = left,
		axis line style = thick,
		...
		\end{axis}
		\end{tikzpicture}
		\begin{tikzpicture}[scale = .98] %1/2 time dilation
		\begin{axis}[
		axis lines = left,
		axis line style = thick,
	...
	\subsubsection*{Invariant:} \[
		\left(x'\right)^2-\left(ct'\right)^2 = x^2-\left(ct\right)^2 = \pm a^2
	\]
